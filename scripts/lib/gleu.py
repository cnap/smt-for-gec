...
Updated 7 Sept 2017: Normalizes brackets before evaluation
"""
...
class GLEU:
    ...
    def normalize_brackets(self, toks):
        """normalize PTB-style brackets"""
        for i, tok in enumerate(toks):
            if tok.lower() in BRACKETS:
                toks[i] = BRACKETS[tok.lower()]


    def get_ngram_counts(self, sentence, n):
        """get ngrams of order n for a tokenized sentence"""
        self.normalize_brackets(sentence)
